...
export  default function Page () {
    ...
    const getImg = async () => {
        try {
            const res = await fetch(`https://scano-0df0b7c835bf.herokuapp.com/files/${profile?.photo_url}`,
                {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    async function getProfile () {
        ...
        if (res.ok) {
            ...
            form.setValue('surname', data.last_name);
                        ...
                        {pending ? (
                            ...
                            file ? (
                                ...
                                profile?.photo_url ? (
                                    ...
                                    <div
                                        className="w-32 h-32 rounded border overflow-hidden flex items-center justify-center">
                                        <Input onChange={handleChangePhoto} id="picture" type="file" accept="image/*"
                                               className="appearance-none cursor-pointer w-32 h-32 opacity-0 absolute"/>
                        ...
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="flex items-center gap-x-4">
                                <div className="flex items-center gap-x-2">
                                    ...
                                    <p className="text-lg font-medium">{t(profile?.role)}</p>
                                </div>
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger>
